...
<body>
	...
	<main>
		...
		<form action="change-password.php" method="post" class="userform">
			...
			<p>
				...
				<input type="text" name="first_name" <?php echo 'value="' . $first_name . '"'; ?> disabled><!-- avoid to change-->
			</p>
	...
	<script src="js/jquery.js"></script><!-- importing jquery library-->
	<script>
		$(document).ready(function(){
			$('#showpassword').click(function(){//if the event given by id is clicked (any click eveny=t)
				if ( $('#showpassword').is(':checked') ) {//is click is a check
					$('#password').attr('type','text');//then the type of the given id should be changed to the .......
				} else {
					$('#password').attr('type','password');//else type shold be ...........
				}
			});
		});
	</script>
